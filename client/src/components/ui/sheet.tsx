  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={`fixed z-50 gap-4 bg-white dark:bg-gray-800 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300 ${sideClasses[side]} ${className || ""}`}
        {...props}
      >
        {children}
